...
export const mockTournaments: Tournament[] = [
  { id: 'tour-01', name: '裂隙冠军夜', game: GameTitle.LOL, format: TournamentFormat.SINGLE_ELIM, teamSize: 5, maxTeams: 16, startDate: '2026-06-18', endDate: '2026-06-21', prize: '冠军皮肤基金 20000 元', status: TournamentStatus.IN_PROGRESS, rules: 'BO3 单败淘汰，决赛 BO5。', teams: ['team-03', 'team-06'], waitlist: [], bracket: { rounds: [{ name: '半决赛', matches: [{ id: 'm-03', teamA: 'team-03', teamB: 'team-06', scoreA: 2, scoreB: 1 }] }] } },
  { id: 'tour-02', name: 'Red Spike Open', game: GameTitle.VALORANT, format: TournamentFormat.DOUBLE_ELIM, teamSize: 5, maxTeams: 12, startDate: '2026-06-20', endDate: '2026-06-23', prize: '外设套装与训练房时长', status: TournamentStatus.REGISTRATION, rules: '双败淘汰，地图池随机。', teams: ['team-02', 'team-09'], waitlist: [], bracket: { rounds: [{ name: '胜者组 R1', matches: [{ id: 'm-02', teamA: 'team-02', teamB: 'team-09', scoreA: 0, scoreB: 0 }] }] } },
  { id: 'tour-03', name: 'Dustline Masters', game: GameTitle.CSGO, format: TournamentFormat.ROUND_ROBIN, teamSize: 5, maxTeams: 10, startDate: '2026-06-14', endDate: '2026-06-28', prize: '现金 30000 元', status: TournamentStatus.IN_PROGRESS, rules: '循环赛积分，胜 3 平 1。', teams: ['team-01', 'team-07'], waitlist: [], bracket: { rounds: [{ name: '循环轮次', matches: [{ id: 'm-01', teamA: 'team-01', teamB: 'team-07', scoreA: 16, scoreB: 11 }] }] } },
  { id: 'tour-04', name: 'Aegis Weekend', game: GameTitle.DOTA2, format: TournamentFormat.POINT_BASED, teamSize: 5, maxTeams: 8, startDate: '2026-06-10', endDate: '2026-06-12', prize: '训练营名额', status: TournamentStatus.FINISHED, rules: '积分赛，按净胜局排序。', teams: ['team-04', 'team-08'], waitlist: [], bracket: { rounds: [{ name: '积分轮', matches: [{ id: 'm-04', teamA: 'team-04', teamB: 'team-08', scoreA: 2, scoreB: 0 }] }] } },
  { id: 'tour-05', name: 'Final Ring Cup', game: GameTitle.PUBG, format: TournamentFormat.POINT_BASED, teamSize: 4, maxTeams: 16, startDate: '2026-06-26', endDate: '2026-06-27', prize: '奖金池 15000 元', status: TournamentStatus.REGISTRATION, rules: '六场积分，击杀和排名双积分。', teams: ['team-05', 'team-10'], waitlist: [], bracket: { rounds: [{ name: '地图轮换', matches: [{ id: 'm-05', teamA: 'team-05', teamB: 'team-10', scoreA: 0, scoreB: 0 }] }] } },
  { id: 'tour-06', name: 'Mid Lane Lab', game: GameTitle.LOL, format: TournamentFormat.ROUND_ROBIN, teamSize: 5, maxTeams: 8, startDate: '2026-07-02', endDate: '2026-07-05', prize: '战队推广位', status: TournamentStatus.REGISTRATION, rules: '同组双循环，禁用重复英雄。', teams: ['team-03'], waitlist: [], bracket: { rounds: [{ name: '小组赛', matches: [{ id: 'm-06', teamA: 'team-03', teamB: 'team-06', scoreA: 0, scoreB: 0 }] }] } },
  { id: 'tour-07', name: 'Utility Draft', game: GameTitle.CSGO, format: TournamentFormat.SINGLE_ELIM, teamSize: 5, maxTeams: 8, startDate: '2026-07-08', endDate: '2026-07-09', prize: '社区认证徽章', status: TournamentStatus.REGISTRATION, rules: '单败 BO1，决赛 BO3。', teams: ['team-07'], waitlist: [], bracket: { rounds: [{ name: '八强', matches: [{ id: 'm-07', teamA: 'team-01', teamB: 'team-07', scoreA: 0, scoreB: 0 }] }] } },
  { id: 'tour-08', name: 'Dire Current Series', game: GameTitle.DOTA2, format: TournamentFormat.DOUBLE_ELIM, teamSize: 5, maxTeams: 12, startDate: '2026-05-21', endDate: '2026-05-25', prize: '复盘课包', status: TournamentStatus.FINISHED, rules: '胜者组 BO3，败者组 BO1。', teams: ['team-04', 'team-08'], waitlist: [], bracket: { rounds: [{ name: '败者组决赛', matches: [{ id: 'm-08', teamA: 'team-04', teamB: 'team-08', scoreA: 1, scoreB: 2 }] }] } },
  { id: 'tour-09', name: 'Harbor Night', game: GameTitle.VALORANT, format: TournamentFormat.SINGLE_ELIM, teamSize: 5, maxTeams: 8, startDate: '2026-05-14', endDate: '2026-05-15', prize: '点券 8000', status: TournamentStatus.FINISHED, rules: 'BO3，禁用同图连选。', teams: ['team-02', 'team-09'], waitlist: [], bracket: { rounds: [{ name: '决赛', matches: [{ id: 'm-09', teamA: 'team-02', teamB: 'team-09', scoreA: 2, scoreB: 0 }] }] } },
  { id: 'tour-10', name: 'Blue Zone Trials', game: GameTitle.PUBG, format: TournamentFormat.ROUND_ROBIN, teamSize: 4, maxTeams: 16, startDate: '2026-04-30', endDate: '2026-05-02', prize: '直播推荐位', status: TournamentStatus.FINISHED, rules: '三日积分，禁止换人。', teams: ['team-05', 'team-10'], waitlist: [], bracket: { rounds: [{ name: '最终日', matches: [{ id: 'm-10', teamA: 'team-05', teamB: 'team-10', scoreA: 68, scoreB: 54 }] }] } },
];
